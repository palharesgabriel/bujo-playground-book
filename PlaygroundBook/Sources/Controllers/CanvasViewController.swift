...
public class CanvasViewController: UIViewController, UIPopoverPresentationControllerDelegate {
    ...
    lazy var titleLabel: UIImageView = {
        let image = UIImageView(image: UIImage(named: "Daily Goals"))
    ...
    override public func viewDidLoad() {
        ...
        self.bulletComponents = [
            UIImage(named: "task"),
            UIImage(named: "task-in-progress"),
            UIImage(named: "task-completed"),
            UIImage(named: "event"),
            UIImage(named: "event-in-progress"),
            UIImage(named: "event-completed"),
            UIImage(named: "coracao"),
            UIImage(named: "star")]
...
extension CanvasViewController : LabelPopoverDelegate {
